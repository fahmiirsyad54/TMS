    ...
    function get_menu(){
        ...
        foreach ($datamenu as $menu) {
            if ($menu->intis_header == 0) {
                ...
                $html .= '<li class="dropdown '. $this->get_submenu($menu->intid)['open'] .'">';
                $html .= '<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="' . $menu->vcicon . '"></i> <span >' . $menu->vcnama . '</span>';
                $html .= '<span class="pull-right-container"><i class="caret"></i></span></a>';
    ...
    function get_submenu($intparent){
        ...
        foreach ($datamenu as $menu) {
            ...
            if ($menu->intis_header == 2) {
                $html .= '<li class="dropdown '. $this->get_submenu2($menu->intid)['open'] .'">';
                $html .= '<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-circle-o"></i> <span>' . $menu->vcnama . '</span>';
                $html .= '<span class="pull-right-container"><i class="caret"></i></span></a>';
                $html .= '<ul class="dropdown-menu" role="menu">';
