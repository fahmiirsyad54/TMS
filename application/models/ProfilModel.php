...
class ProfilModel extends CI_Model {
    ...
    function getdatadetail($table,$intid){ 
        $this->db->select('a.intid, a.vckode, a.vcnama, a.vcpassword, a.vcusername, a.inthakakses, a.vchakakses, a.dtupdate, a.intstatus, ISNULL(b.vcnama, 0) as vcstatus, ISNULL(b.vcwarna, 0) as vcstatuswarna',false);
        $this->db->from($table . ' as a');
        $this->db->join('app_mstatus' . ' as b', 'a.intstatus = b.intstatus', 'left');
