<div class="row">
	<div class="col-md-12">
		<div class="box">
			...
			<div class="box-body">
				<div class="row">
					<form method="POST" id="postdata" action="<?=base_url($controller . '/simpan_peminjam/')?>">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="vcgedung" placeholder="Code" id="vcgedung" class="form-control" value="<?=$vcgedung?>" readonly/>
                                <input type="hidden" name="intgedung" placeholder="Code" id="intgedung" class="form-control" value="<?=$intgedung?>" readonly/>
                            </div>
