					...
					<form method="POST" id="postdata" action="<?=base_url($controller . '/aksi/' . $action . '/' . $intid)?>">
						<div class="col-md-6">
							...
							<!-- <div class="form-group">
								...
								<select name="intgedung" class="form-control" id="intgedung" readonly>
							...
							<input type="hidden" name="intgedung" class="form-control" id="intgedung" required value="<?=$intgedung?>" />
						</div>
