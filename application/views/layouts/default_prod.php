...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <div class="container">
            ...
            <h1>
              <a href="<?=base_url('production/dashboard/view/')?>" style=" color: #000000"> <i class="fa fa-arrow-circle-left"></i> Dashboard</a>
            </h1>
              <ol class="breadcrumb">
                <li><a href="<?=base_url('production/dashboard/view/')?>"><i class="fa fa-dashboard"></i> Home</a></li>
  ...
  <footer class="main-footer" style="background: #222d32" >
    <div class="pull-right hidden-xs">
      <b style="color:white">Version 1.0</b> 
    </div>
    <strong style="color:white"> Copyright &copy; 2020 ME Departement - <a href="http://www.hsinni.com/">PT Hwa Seung Indonesia</a>. All rights
    reserved. </strong>
  </footer>
